        ...
        <div className="flex  items-center justify-between gap-8 text-[#ffffffef]">
          ...
          <div>
            <div className="flex flex-col gap-4 xsm:flex-row md:p-0">
              <input
                className="px-4 py-3 text-lg text-black transition-all duration-300 rounded-[10px] focus:outline-none focus:right-1 "
                placeholder="Enter your email"
                type="text"
              />
              <button className="px-6 py-4 font-semibold bg-[#000] rounded-[10px]">
                Subscribe
              </button>
            </div>
